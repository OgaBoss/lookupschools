                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="/guest/inbox"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">{{ count($messages) }}</span></a></li>
                                <li><a href="/guest/sent_message"><i class="fa fa-envelope-o"></i> Sent</a></li>
                            </ul>
                        </div><!-- /.box-body -->
                    </div><!-- /. box -->
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    @forelse($messages as $msg)
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a href="/school/message/{{ $msg->id }}">{{ ucfirst($msg->sender_identity) }}</a></td>
